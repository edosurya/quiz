            ...
            <ul class="flex flex-col py-4 space-y-1">
                ...
                <li>
					...
					<span class="inline-flex justify-center items-center ml-4">
                        ...
                        <span class="ml-2 text-sm tracking-wide truncate">My activity</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('user_quizzes') }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-blue-500 border-l-4 border-transparent hover:border-blue-500 pr-6">
                        ...
                        <span class="ml-2 text-sm tracking-wide truncate">Your quizzes</span>
                    </a>
                </li>
                <li>
                    <a href="{{route('select_quiz_type')}}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-blue-500 border-l-4 border-transparent hover:border-blue-500 pr-6">
                        ...
                        <span class="ml-2 text-sm tracking-wide truncate">Create a quiz</span>
                    </a>
                </li>
                @can('isAdmin')
                <li class="px-5">
                ...
                <li>
					...
					<span class="inline-flex justify-center items-center ml-4">
                        ...
                        <span class="ml-2 text-sm tracking-wide truncate">Quizz</span>
                ...
                <li class="px-5">
                    <div class="flex flex-row items-center h-8">
                        <div class="text-sm font-light tracking-wide text-gray-500">Manage your account</div>
                    </div>
                </li>
                <li>
					...
					<span class="inline-flex justify-center items-center ml-4">
                        ...
                        <span class="ml-2 text-sm tracking-wide truncate">Account settings</span>
                    </a>
                </li>
                @can('isAdmin')
                <li>
					...
					<span class="inline-flex justify-center items-center ml-4">
                        ...
                        <span class="ml-2 text-sm tracking-wide truncate">Page settings</span>
                    </a>
                </li>
                @endcan
                <li>
